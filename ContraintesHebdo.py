...
class Ui_FormHebdo(object):
    ...
    def close(self):
            FormHebdo.hide()            
    def setupUi(self, FormHebdo):
        FormHebdo.setObjectName("FormHebdo")
        FormHebdo.resize(559, 230)
        self.widget = QtWidgets.QWidget(FormHebdo)
...
"font: 28pt \"Playball\";")
        ...
        self.retranslateUi(FormHebdo)
        QtCore.QMetaObject.connectSlotsByName(FormHebdo)

    def retranslateUi(self, FormHebdo):
        _translate = QtCore.QCoreApplication.translate
        FormHebdo.setWindowTitle(_translate("FormHebdo", "Choisir les contraintes"))
        self.HS.setText(_translate("FormHebdo", "Heures Supplémentaires"))
        self.LP.setText(_translate("FormHebdo", "Lissage de la production"))
        self.ST.setText(_translate("FormHebdo", "Sous-taitance"))

        self.OK.setText(_translate("FormHebdo", "Valider les contraintes"))
        self.label.setText(_translate("FormHebdo", "Choisir les contraintes"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    FormHebdo = QtWidgets.QWidget()
    ui = Ui_FormHebdo()
    ui.setupUi(FormHebdo)
    FormHebdo.show()
    sys.exit(app.exec_())

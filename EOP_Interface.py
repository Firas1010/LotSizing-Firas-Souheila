...
class Ui_EOP_Interface(object):
    ...
    def loadaPOQ(self):
        ...
        df = pd.read_excel('C:/LotSizing/OUTPUTS/OUTPUTSEPQ.xlsx')
        if df.size == 0:
            return
    ...
    def imprimerapport(self):
        data=pd.read_excel("C:/LotSizing/OUTPUTS/OUTPUTSEPQ.xlsx")
        df=pd.DataFrame(data)         
        ...
        pdf.image("C:/LotSizing/OUTPUTS/OUTPUTSEPQ.png",0,30,200)
        pdf.ln(3)
        ...
        if c1>0:
             ...
             pdf.cell(-90)         
        pdf.output('C:/LotSizing/OUTPUTS/RapportEPQ.pdf', 'F')
        
    def imprimegraphe(self):
        filepath2="C:/LotSizing/OUTPUTS/OUTPUTSEPQ.png"
        os.startfile(filepath2,'print')          
    def loadaGrapheQEC(self):
        file='C:/LotSizing/OUTPUTS/OUTPUTSEPQ.xlsx'
        data=pd.read_excel(file)
        df=pd.DataFrame(data)   
        X=df.iloc[5,1:10]
        Y=df.iloc[6,1:10]
        ...
        plt.show()
        plt.savefig('C:/LotSizing/OUTPUTS/OUTPUTSEPQ.png');    
    ...
    def setupUi(self, EOP_Interface):
        EOP_Interface.setObjectName("EOP_Interface")
        EOP_Interface.resize(1342, 597)
        self.tableWidget = QtWidgets.QTableWidget(EOP_Interface)
        self.tableWidget.setGeometry(QtCore.QRect(0, 0, 1341, 381))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.widget = QtWidgets.QWidget(EOP_Interface)
...
"font: 75 16pt \"MS Shell Dlg 2\";")
        ...
        self.widget_2 = QtWidgets.QWidget(EOP_Interface)
...
"border-image: url(:/pic/Printer-icon.png);")
        ...
        self.retranslateUi(EOP_Interface)
        QtCore.QMetaObject.connectSlotsByName(EOP_Interface)
        self.ValiderModification.clicked.connect(self.loadaPOQ)
    ...
    def retranslateUi(self, EOP_Interface):
        _translate = QtCore.QCoreApplication.translate
        EOP_Interface.setWindowTitle(_translate("EOP_Interface", "Economic order periode_Interface"))
        self.label_8.setText(_translate("EOP_Interface", "load"))
        self.label_9.setText(_translate("EOP_Interface", "Save"))

        self.GrapheBtn.setText(_translate("EOP_Interface", "Visualiser le graphiqe"))

        self.ComparaisonGraphique.setText(_translate("EOP_Interface", "Comparer les autres graphique"))

        self.ValiderModification.setText(_translate("EOP_Interface", "Valider Les modifications"))
...
if __name__ == "__main__":
    ...
    EOP_Interface = QtWidgets.QWidget()
    ui = Ui_EOP_Interface()
    ui.setupUi(EOP_Interface)
    EOP_Interface.show()
    sys.exit(app.exec_())

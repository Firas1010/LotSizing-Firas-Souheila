...
class Ui_EPQAnnuel(object):
    ...
    def loadaQEC(self):
        ...
        df = pd.read_excel('C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSEPQ.xlsx')
        if df.size == 0:
            return
    ...
    def imprimerapport(self):
        data=pd.read_excel("C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSEPQ.xlsx")
        df=pd.DataFrame(data)         
        ...
        pdf.image("C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSEPQ.png",0,30,200)
        pdf.ln(3)
        ...
        if c1>0:
             ...
             pdf.cell(-90)         
        pdf.output('C:/LotSizing/OUTPUTSAnnuel/RapportEPQAnnuelle.pdf', 'F')
        
    def imprimegraphe(self):
        filepath2="C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSEPQ.png"
    ...
    def loadaGrapheQEC(self):
        file='C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSEPQ.xlsx'
        data=pd.read_excel(file)
        df=pd.DataFrame(data)   
        X=df.iloc[5,1:14]
        Y=df.iloc[6,1:14]
        ...
        plt.show()
        plt.savefig('C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSEPQ.png')   
    ...
    def setupUi(self, EPQAnnuel):
        EPQAnnuel.setObjectName("EPQAnnuel")
        EPQAnnuel.resize(1342, 597)
        self.tableWidget = QtWidgets.QTableWidget(EPQAnnuel)
        self.tableWidget.setGeometry(QtCore.QRect(0, 0, 1341, 381))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.widget = QtWidgets.QWidget(EPQAnnuel)
...
"border-image: url(:/pic/Printer-icon.png);")
        ...
        self.retranslateUi(EPQAnnuel)
        QtCore.QMetaObject.connectSlotsByName(EPQAnnuel)
        

    def retranslateUi(self, EPQAnnuel):
        _translate = QtCore.QCoreApplication.translate
        EPQAnnuel.setWindowTitle(_translate("EPQAnnuel", "EPQAnnuel"))
        self.label_8.setText(_translate("EPQAnnuel", "load"))
        self.label_9.setText(_translate("EPQAnnuel", "Save"))

        self.GrapheBtn.setText(_translate("EPQAnnuel", "Visualiser le graphiqe"))

        self.ComparaisonGraphique.setText(_translate("EPQAnnuel", "Comparer les autres graphique"))

        self.ValiderModification.setText(_translate("EPQAnnuel", "Valider Les modifications"))
import img
...
if __name__ == "__main__":
    ...
    EPQAnnuel = QtWidgets.QWidget()
    ui = Ui_EPQAnnuel()
    ui.setupUi(EPQAnnuel)
    EPQAnnuel.show()
    sys.exit(app.exec_())

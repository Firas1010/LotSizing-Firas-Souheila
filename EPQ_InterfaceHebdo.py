...
class Ui_EPQHebdo(object):
    ...
    def loadaQEC(self):
        ...
        df = pd.read_excel('C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSEPQ.xlsx')
        if df.size == 0:
            return
    ...
    def imprimerapport(self):
        data=pd.read_excel("C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSEPQ.xlsx")
        df=pd.DataFrame(data)         
        ...
        pdf.image("C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSEPQ.png",0,30,200)
        pdf.ln(3)
        a=df.iloc[7,1:52].tolist()
        i=0
        for i in a :
         a.remove(i)
         c1=len(a)        
        ...
        pdf.output('C:/LotSizing/OUTPUTSHebdo/RapportEPQHebdo.pdf', 'F')

    def imprimegraphe(self):
        filepath2="C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSEPQ.png"
        os.startfile(filepath2,'print')                 
    def loadaGrapheQEC(self):
        file='C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSEPQ.xlsx'
        data=pd.read_excel(file)
        df=pd.DataFrame(data)   
        X=df.iloc[5,1:54]
        Y=df.iloc[6,1:54]
        ...
        plt.show()   
        plt.savefig('C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSEPQ.png')         
    ...
    def setupUi(self, EPQHebdo):
        EPQHebdo.setObjectName("EPQHebdo")
        EPQHebdo.resize(1342, 597)
        self.tableWidget = QtWidgets.QTableWidget(EPQHebdo)
        self.tableWidget.setGeometry(QtCore.QRect(0, 0, 1341, 381))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.widget = QtWidgets.QWidget(EPQHebdo)
...
"font: 75 16pt \"MS Shell Dlg 2\";")
        ...
        self.widget_2 = QtWidgets.QWidget(EPQHebdo)
...
"border-image: url(:/pic/Printer-icon.png);")
        ...
        self.retranslateUi(EPQHebdo)
        QtCore.QMetaObject.connectSlotsByName(EPQHebdo)

    def retranslateUi(self, EPQHebdo):
        _translate = QtCore.QCoreApplication.translate
        EPQHebdo.setWindowTitle(_translate("EPQHebdo", "EPQHebdo"))
        self.label_8.setText(_translate("EPQHebdo", "load"))
        self.label_9.setText(_translate("EPQHebdo", "Save"))

        self.GrapheBtn.setText(_translate("EPQHebdo", "Visualiser le graphiqe"))

        self.ComparaisonGraphique.setText(_translate("EPQHebdo", "Comparer les autres graphique"))

        self.ValiderModification.setText(_translate("EPQHebdo", "Valider Les modifications"))
import img

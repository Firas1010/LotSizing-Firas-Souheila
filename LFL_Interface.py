...
class Ui_LFL_Interface(object):
    ...
    def loadaLFL(self):
        ...
        df = pd.read_excel('C:/LotSizing/OUTPUTS/OUTPUTSLFL.xlsx')
        if df.size == 0:
            return
    ...
    def imprimerapport(self):
        ...
        pdf.image("C:/LotSizing/OUTPUTS/OUTPUTSLFL.png",0,30,200)
        pdf.ln(3)
        ...
        if c1>0:
             ...
             pdf.cell(-90)         
        pdf.output('C:/LotSizing/OUTPUTS/RapportLFL.pdf', 'F')
        
    def imprimegraphe(self):
        filepath2="C:/LotSizing/OUTPUTS/OUTPUTSLFL.png"
        os.startfile(filepath2,'print')         
    def loadaGrapheQEC(self):
        file='C:/LotSizing/OUTPUTS/OUTPUTSLFL.xlsx'
        data=pd.read_excel(file)
        df=pd.DataFrame(data)   
        X=df.iloc[5,1:10]
        Y=df.iloc[6,1:10]
        ...
        plt.show() 
        plt.savefig('C:/LotSizing/OUTPUTS/OUTPUTSLFL.png');    
    def comparaisongraphe(self):
        ...
        index = ['Coût LFL ', 'Coût EPQ', 'Coût Luc','Coût ME', 'Coût PPB', 'Coût QEC', 'Coût SM']
    ...
    def setupUi(self, LFL_Interface):
        LFL_Interface.setObjectName("LFL_Interface")
        LFL_Interface.resize(1342, 597)
        self.tableWidget = QtWidgets.QTableWidget(LFL_Interface)
        self.tableWidget.setGeometry(QtCore.QRect(0, 0, 1341, 381))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.widget = QtWidgets.QWidget(LFL_Interface)
...
"font: 75 16pt \"MS Shell Dlg 2\";")
        ...
        self.widget_2 = QtWidgets.QWidget(LFL_Interface)
...
"border-image: url(:/pic/Printer-icon.png);")
        ...
        self.retranslateUi(LFL_Interface)
        QtCore.QMetaObject.connectSlotsByName(LFL_Interface)
        self.ValiderModification.clicked.connect(self.loadaLFL)
    ...
    def retranslateUi(self, LFL_Interface):
        _translate = QtCore.QCoreApplication.translate
        LFL_Interface.setWindowTitle(_translate("LFL_Interface", "Lot For Lot_Interface"))
        self.label_8.setText(_translate("LFL_Interface", "load"))
        self.label_9.setText(_translate("LFL_Interface", "Save"))

        self.GrapheBtn.setText(_translate("LFL_Interface", "Visualiser le graphiqe"))
        
        self.ComparaisonGraphique.setText(_translate("LFL_Interface", "Comparer les autres graphique"))

        self.ValiderModification.setText(_translate("LFL_Interface", "Valider Les modifications"))
...
if __name__ == "__main__":
    ...
    LFL_Interface = QtWidgets.QWidget()
    ui = Ui_LFL_Interface()
    ui.setupUi(LFL_Interface)
    LFL_Interface.show()
    sys.exit(app.exec_())

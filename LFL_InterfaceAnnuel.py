...
class Ui_LFLAnnuel(object):
    ...
    def loadaQEC(self):
        ...
        df = pd.read_excel('C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSLFL.xlsx')
        if df.size == 0:
            return
    ...
    def imprimerapport(self):        
        ...
        pdf.image("C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSLFL.png",0,30,200)
        pdf.ln(3)
        ...
        if c1>0:
             ...
             pdf.cell(-90)         
        pdf.output('C:/LotSizing/OUTPUTSAnnuel/RapportLFLAnnuel.pdf', 'F')
        
    def imprimegraphe(self):
        filepath2="C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSLFL.png"
    ...
    def loadaGrapheQEC(self):
        file='C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSLFL.xlsx'
        data=pd.read_excel(file)
        df=pd.DataFrame(data)   
        X=df.iloc[5,1:14]
        Y=df.iloc[6,1:14]
        ...
        plt.show()
        plt.savefig('C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSLFL.png')
    ...
    def setupUi(self, LFLAnnuel):
        LFLAnnuel.setObjectName("LFLAnnuel")
        LFLAnnuel.resize(1342, 597)
        self.tableWidget = QtWidgets.QTableWidget(LFLAnnuel)
        self.tableWidget.setGeometry(QtCore.QRect(0, 0, 1341, 381))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.widget = QtWidgets.QWidget(LFLAnnuel)
...
"border-image: url(:/pic/Printer-icon.png);")
        ...
        self.retranslateUi(LFLAnnuel)
        QtCore.QMetaObject.connectSlotsByName(LFLAnnuel)
        

    def retranslateUi(self, LFLAnnuel):
        _translate = QtCore.QCoreApplication.translate
        LFLAnnuel.setWindowTitle(_translate("LFLAnnuel", "LFLAnnuel"))
        self.label_8.setText(_translate("LFLAnnuel", "load"))
        self.label_9.setText(_translate("LFLAnnuel", "Save"))

        self.GrapheBtn.setText(_translate("LFLAnnuel", "Visualiser le graphiqe"))

        self.ComparaisonGraphique.setText(_translate("LFLAnnuel", "Comparer les autres graphique"))

        self.ValiderModification.setText(_translate("LFLAnnuel", "Valider Les modifications"))
import img
...
if __name__ == "__main__":
    ...
    LFLAnnuel = QtWidgets.QWidget()
    ui = Ui_LFLAnnuel()
    ui.setupUi(LFLAnnuel)
    LFLAnnuel.show()
    sys.exit(app.exec_())

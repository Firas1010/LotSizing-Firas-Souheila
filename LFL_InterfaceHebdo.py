...
class Ui_LFLHebdo(object):
    ...
    def loadaQEC(self):
      #import LFL
        ...
        df = pd.read_excel('C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSLFL.xlsx')
        if df.size == 0:
            return
    ...
    def imprimerapport(self):
        ...
        pdf.image("C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSLFL.png",0,30,200)
        pdf.ln(3)
        ...
        if c1>0:
             ...
             pdf.cell(-90)         
        pdf.output('C:/LotSizing/OUTPUTSHebdo/RapportLFLHEBDO.pdf', 'F')

    def imprimegraphe(self):
        filepath2="C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSLFL.png"
        os.startfile(filepath2,'print')                  
    def loadaGrapheQEC(self):
        file='C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSLFL.xlsx'
        data=pd.read_excel(file)
        df=pd.DataFrame(data)   
        X=df.iloc[5,1:54]
        Y=df.iloc[6,1:54]
        ...
        plt.show()    
        plt.savefig('C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSLFL.png')
    ...
    def setupUi(self, LFLHebdo):
        LFLHebdo.setObjectName("LFLHebdo")
        LFLHebdo.resize(1342, 597)
        self.tableWidget = QtWidgets.QTableWidget(LFLHebdo)
        self.tableWidget.setGeometry(QtCore.QRect(0, 0, 1341, 381))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.widget = QtWidgets.QWidget(LFLHebdo)
...
"font: 75 16pt \"MS Shell Dlg 2\";")
        ...
        self.widget_2 = QtWidgets.QWidget(LFLHebdo)
...
"border-image: url(:/pic/Printer-icon.png);")
        ...
        self.retranslateUi(LFLHebdo)
        QtCore.QMetaObject.connectSlotsByName(LFLHebdo)

    def retranslateUi(self, LFLHebdo):
        _translate = QtCore.QCoreApplication.translate
        LFLHebdo.setWindowTitle(_translate("LFLHebdo", "LFLHebdo"))
        self.label_8.setText(_translate("LFLHebdo", "load"))
        self.label_9.setText(_translate("LFLHebdo", "Save"))

        self.GrapheBtn.setText(_translate("LFLHebdo", "Visualiser le graphiqe"))

        self.ComparaisonGraphique.setText(_translate("LFLHebdo", "Comparer les autres graphique"))

        self.ValiderModification.setText(_translate("LFLHebdo", "Valider Les modifications"))
import img

...
class Ui_LUCAnnuel(object):
    ...
    def loadaQEC(self):
        ...
        df = pd.read_excel('C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSLUC.xlsx')
        if df.size == 0:
            return
    ...
    def imprimerapport(self):
        data=pd.read_excel("C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSLUC.xlsx")
        df=pd.DataFrame(data)         
        ...
        pdf.image("C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSLUC.png",0,30,200)
        pdf.ln(3)
        ...
        if c1>0:
             ...
             pdf.cell(-90)         
        pdf.output('C:/LotSizing/OUTPUTSAnnuel/RapportLUCAnnuel.pdf', 'F')
        
    def imprimegraphe(self):
        filepath2="C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSLUC.png"
    ...
    def loadaGrapheQEC(self):
        file='C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSLUC.xlsx'
        data=pd.read_excel(file)
        df=pd.DataFrame(data)   
        X=df.iloc[5,1:14]
        Y=df.iloc[6,1:14]
        ...
        plt.show()
        plt.savefig('C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSLUC.png')   
    ...
    def setupUi(self, LUCAnnuel):
        LUCAnnuel.setObjectName("LUCAnnuel")
        LUCAnnuel.resize(1342, 597)
        self.tableWidget = QtWidgets.QTableWidget(LUCAnnuel)
        self.tableWidget.setGeometry(QtCore.QRect(0, 0, 1341, 381))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.widget = QtWidgets.QWidget(LUCAnnuel)
...
"border-image: url(:/pic/Printer-icon.png);")
        ...
        self.retranslateUi(LUCAnnuel)
        QtCore.QMetaObject.connectSlotsByName(LUCAnnuel)
        

    def retranslateUi(self, LUCAnnuel):
        _translate = QtCore.QCoreApplication.translate
        LUCAnnuel.setWindowTitle(_translate("LUCAnnuel", "LUCAnnuel"))
        self.label_8.setText(_translate("LUCAnnuel", "load"))
        self.label_9.setText(_translate("LUCAnnuel", "Save"))

        self.GrapheBtn.setText(_translate("LUCAnnuel", "Visualiser le graphiqe"))

        self.ComparaisonGraphique.setText(_translate("LUCAnnuel", "Comparer les autres graphique"))

        self.ValiderModification.setText(_translate("LUCAnnuel", "Valider Les modifications"))
import img
...
if __name__ == "__main__":
    ...
    LUCAnnuel = QtWidgets.QWidget()
    ui = Ui_LUCAnnuel()
    ui.setupUi(LUCAnnuel)
    LUCAnnuel.show()
    sys.exit(app.exec_())

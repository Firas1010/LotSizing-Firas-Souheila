...
class Ui_LUCHebdo(object):
    ...
    def loadaQEC(self):
        ...
        df = pd.read_excel('C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSLUC.xlsx')
        if df.size == 0:
            return
    ...
    def imprimerapport(self):
        data=pd.read_excel("C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSLUC.xlsx")
        df=pd.DataFrame(data)         
        ...
        pdf.image("C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSLUC.png",0,30,200)
        pdf.ln(3)
        ...
        if c1>0:
             ...
             pdf.cell(-90)         
        pdf.output('C:/LotSizing/OUTPUTSHebdo/RapportLUCHEBDO.pdf', 'F')

    def imprimegraphe(self):
        filepath2="C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSLUC.png"
        os.startfile(filepath2,'print')                    
    def loadaGrapheQEC(self):
        file='C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSLUC.xlsx'
        data=pd.read_excel(file)
        df=pd.DataFrame(data)   
        X=df.iloc[5,1:54]
        Y=df.iloc[6,1:54]
        ...
        plt.show()   
        plt.savefig('C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSLUC.png')        
    ...
    def setupUi(self, LUCHebdo):
        LUCHebdo.setObjectName("LUCHebdo")
        LUCHebdo.resize(1342, 597)
        self.tableWidget = QtWidgets.QTableWidget(LUCHebdo)
        self.tableWidget.setGeometry(QtCore.QRect(0, 0, 1341, 381))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.widget = QtWidgets.QWidget(LUCHebdo)
...
"font: 75 16pt \"MS Shell Dlg 2\";")
        ...
        self.widget_2 = QtWidgets.QWidget(LUCHebdo)
...
"border-image: url(:/pic/Printer-icon.png);")
        ...
        self.retranslateUi(LUCHebdo)
        QtCore.QMetaObject.connectSlotsByName(LUCHebdo)

    def retranslateUi(self, LUCHebdo):
        _translate = QtCore.QCoreApplication.translate
        LUCHebdo.setWindowTitle(_translate("LUCHebdo", "LUCHebdo"))
        self.label_8.setText(_translate("LUCHebdo", "load"))
        self.label_9.setText(_translate("LUCHebdo", "Save"))

        self.GrapheBtn.setText(_translate("LUCHebdo", "Visualiser le graphiqe"))

        self.ComparaisonGraphique.setText(_translate("LUCHebdo", "Comparer les autres graphique"))

        self.ValiderModification.setText(_translate("LUCHebdo", "Valider Les modifications"))
import img

...
class Ui_ME_Interface(object):
    ...
    def loadaME(self):
        ...
        df = pd.read_excel('C:/LotSizing/OUTPUTS/OUTPUTSME.xlsx')
        if df.size == 0:
            return
    ...
    def imprimerapport(self):
        data=pd.read_excel("C:/LotSizing/OUTPUTS/OUTPUTSME.xlsx")
        df=pd.DataFrame(data)         
        ...
        pdf.image("C:/LotSizing/OUTPUTS/OUTPUTSME.png",0,30,200)
        pdf.ln(3)
        ...
        if c1>0:
             ...
             pdf.cell(-90)         
        pdf.output('C:/LotSizing/OUTPUTS/RapportME.pdf', 'F')
        
    def imprimegraphe(self):
        filepath2="C:/LotSizing/OUTPUTS/OUTPUTSME.png"
        os.startfile(filepath2,'print')           
    def loadaGrapheQEC(self):
        file='C:/LotSizing/OUTPUTS/OUTPUTSME.xlsx'
        data=pd.read_excel(file)
        df=pd.DataFrame(data)   
        X=df.iloc[5,1:10]
        Y=df.iloc[6,1:10]
        ...
        plt.show()    
        plt.savefig('C:/LotSizing/OUTPUTS/OUTPUTSME.png'); 
    ...
    def setupUi(self, ME_Interface):
        ME_Interface.setObjectName("ME_Interface")
        ME_Interface.resize(1342, 597)
        self.tableWidget = QtWidgets.QTableWidget(ME_Interface)
        self.tableWidget.setGeometry(QtCore.QRect(0, 0, 1341, 381))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.widget = QtWidgets.QWidget(ME_Interface)
...
"font: 75 16pt \"MS Shell Dlg 2\";")
        ...
        self.widget_2 = QtWidgets.QWidget(ME_Interface)
...
"border-image: url(:/pic/Printer-icon.png);")
        ...
        self.retranslateUi(ME_Interface)
        QtCore.QMetaObject.connectSlotsByName(ME_Interface)
        self.ValiderModification.clicked.connect(self.loadaME)
    ...
    def retranslateUi(self, ME_Interface):
        _translate = QtCore.QCoreApplication.translate
        ME_Interface.setWindowTitle(_translate("ME_Interface", "ME_Interface"))
        self.label_8.setText(_translate("ME_Interface", "load"))
        self.label_9.setText(_translate("ME_Interface", "Save"))
        self.GrapheBtn.setText(_translate("ME_Interface", "Visualiser le graphiqe"))
        self.ComparaisonGraphique.setText(_translate("ME_Interface", "Comparer les autres graphique"))

        self.ValiderModification.setText(_translate("ME_Interface", "Valider Les modifications"))
...
if __name__ == "__main__":
    ...
    ME_Interface = QtWidgets.QWidget()
    ui = Ui_ME_Interface()
    ui.setupUi(ME_Interface)
    ME_Interface.show()
    sys.exit(app.exec_())

...
class Ui_MEAnnuel(object):
    ...
    def loadaQEC(self):
        ...
        df = pd.read_excel('C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSME.xlsx')
        if df.size == 0:
            return
        ...
        l1=df.iloc[10,1:8].tolist()
        l1.remove(0)
        c1=len(l1)
        l2=df.iloc[11,1:8].tolist()
        l2.remove(0)
        c2=len(l2)
        l3=df.iloc[12,1:8].tolist()
        l3.remove(0)
        c3=len(l3)
        if  ((df.iloc[21,1])==0 and (df.iloc[22,1])==0 and (df.iloc[23,1])==0)  :  
    ...
    def imprimerapport(self):
        data=pd.read_excel("C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSME.xlsx")
        df=pd.DataFrame(data)         
        ...
        pdf.image("C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSME.png",0,30,200)
        pdf.ln(3)
        ...
        if c1>0:
             ...
             pdf.cell(-90)         
        pdf.output('C:/LotSizing/OUTPUTSAnnuel/RapportMEAnnuelle.pdf', 'F')
        
    def imprimegraphe(self):
        filepath2="C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSME.png"
    ...
    def loadaGrapheQEC(self):
        file='C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSME.xlsx'
        data=pd.read_excel(file)
        df=pd.DataFrame(data)   
        X=df.iloc[5,1:14]
        Y=df.iloc[6,1:14]
        ...
        plt.show()
        plt.savefig('C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSME.png')   
    ...
    def setupUi(self, MEAnnuel):
        MEAnnuel.setObjectName("MEAnnuel")
        MEAnnuel.resize(1342, 597)
        self.tableWidget = QtWidgets.QTableWidget(MEAnnuel)
        self.tableWidget.setGeometry(QtCore.QRect(0, 0, 1341, 381))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.widget = QtWidgets.QWidget(MEAnnuel)
...
"font: 75 16pt \"MS Shell Dlg 2\";")
        ...
        self.widget_2 = QtWidgets.QWidget(MEAnnuel)
...
"color:rgba(255, 255, 255, 210);")
        ...
        self.retranslateUi(MEAnnuel)
        QtCore.QMetaObject.connectSlotsByName(MEAnnuel)
        

    def retranslateUi(self, MEAnnuel):
        _translate = QtCore.QCoreApplication.translate
        MEAnnuel.setWindowTitle(_translate("MEAnnuel", "MEAnnuel"))
        self.label_8.setText(_translate("MEAnnuel", "load"))
        self.label_9.setText(_translate("MEAnnuel", "Save"))

        self.GrapheBtn.setText(_translate("MEAnnuel", "Visualiser le graphiqe"))

        self.ComparaisonGraphique.setText(_translate("MEAnnuel", "Comparer les autres graphique"))

        self.ValiderModification.setText(_translate("MEAnnuel", "Valider Les modifications"))
import img

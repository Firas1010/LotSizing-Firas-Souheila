...
class Ui_MEHebdo(object):
    ...
    def loadaQEC(self):
        ...
        df = pd.read_excel('C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSME.xlsx')
        if df.size == 0:
            return
    ...
    def imprimerapport(self):
        data=pd.read_excel("C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSME.xlsx")
        df=pd.DataFrame(data)         
        ...
        pdf.image("C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSME.png",0,30,200)
        pdf.ln(3)
        ...
        if c1>0:
             ...
             pdf.cell(-90)         
        pdf.output('C:/LotSizing/OUTPUTSHebdo/RapportMEHEBDO.pdf', 'F')

    def imprimegraphe(self):
        filepath2="C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSME.png"
        os.startfile(filepath2,'print')                    
    def loadaGrapheQEC(self):
        file='C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSME.xlsx'
        data=pd.read_excel(file)
        df=pd.DataFrame(data)   
        X=df.iloc[5,1:54]
        Y=df.iloc[6,1:54]
        ...
        plt.show()    
        plt.savefig('C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSME.png')
    ...
    def setupUi(self, MEHebdo):
        MEHebdo.setObjectName("MEHebdo")
        MEHebdo.resize(1342, 597)
        self.tableWidget = QtWidgets.QTableWidget(MEHebdo)
        self.tableWidget.setGeometry(QtCore.QRect(0, 0, 1341, 381))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.widget = QtWidgets.QWidget(MEHebdo)
...
"font: 75 16pt \"MS Shell Dlg 2\";")
        ...
        self.widget_2 = QtWidgets.QWidget(MEHebdo)
...
"border-image: url(:/pic/Printer-icon.png);")
        ...
        self.retranslateUi(MEHebdo)
        QtCore.QMetaObject.connectSlotsByName(MEHebdo)

    def retranslateUi(self, MEHebdo):
        _translate = QtCore.QCoreApplication.translate
        MEHebdo.setWindowTitle(_translate("MEHebdo", "MEHebdo"))
        self.label_8.setText(_translate("MEHebdo", "load"))
        self.label_9.setText(_translate("MEHebdo", "Save"))

        self.GrapheBtn.setText(_translate("MEHebdo", "Visualiser le graphiqe"))

        self.ComparaisonGraphique.setText(_translate("MEHebdo", "Comparer les autres graphique"))

        self.ValiderModification.setText(_translate("MEHebdo", "Valider Les modifications"))
import img

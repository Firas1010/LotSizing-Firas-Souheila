...
class Ui_PPBAnnuel(object):
    ...
    def loadaQEC(self):
        ...
        df = pd.read_excel('C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSPPB.xlsx')
        if df.size == 0:
            return
    ...
    def imprimerapport(self):
        data=pd.read_excel("C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSPPB.xlsx")
        df=pd.DataFrame(data)         
        ...
        pdf.image("C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSPPB.png",0,30,200)
        pdf.ln(3)
        ...
        if c1>0:
             ...
             pdf.cell(-90)         
        pdf.output('C:/LotSizing/OUTPUTSAnnuel/RapportPPBAnnuelle.pdf', 'F')
        
    def imprimegraphe(self):
        filepath2="C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSPPB.png"
    ...
    def loadaGrapheQEC(self):
        file='C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSPPB.xlsx'
        data=pd.read_excel(file)
        df=pd.DataFrame(data)   
        X=df.iloc[5,1:14]
        Y=df.iloc[6,1:14]
        ...
        plt.show()
        plt.savefig('C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSPPB.png')
    ...
    def setupUi(self, PPBAnnuel):
        PPBAnnuel.setObjectName("PPBAnnuel")
        PPBAnnuel.resize(1342, 597)
        self.tableWidget = QtWidgets.QTableWidget(PPBAnnuel)
        self.tableWidget.setGeometry(QtCore.QRect(0, 0, 1341, 381))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.widget = QtWidgets.QWidget(PPBAnnuel)
...
"border-image: url(:/pic/Printer-icon.png);")
        ...
        self.retranslateUi(PPBAnnuel)
        QtCore.QMetaObject.connectSlotsByName(PPBAnnuel)
        

    def retranslateUi(self, PPBAnnuel):
        _translate = QtCore.QCoreApplication.translate
        PPBAnnuel.setWindowTitle(_translate("PPBAnnuel", "PPBAnnuel"))
        self.label_8.setText(_translate("PPBAnnuel", "load"))
        self.label_9.setText(_translate("PPBAnnuel", "Save"))

        self.GrapheBtn.setText(_translate("PPBAnnuel", "Visualiser le graphiqe"))

        self.ComparaisonGraphique.setText(_translate("PPBAnnuel", "Comparer les autres graphique"))

        self.ValiderModification.setText(_translate("PPBAnnuel", "Valider Les modifications"))
import img
...
if __name__ == "__main__":
    ...
    PPBAnnuel = QtWidgets.QWidget()
    ui = Ui_PPBAnnuel()
    ui.setupUi(PPBAnnuel)
    PPBAnnuel.show()
    sys.exit(app.exec_())

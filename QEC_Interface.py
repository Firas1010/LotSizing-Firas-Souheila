...
class Ui_QEC_Interface(object):
    ...
    def loadaQEC(self):
        ...
        df = pd.read_excel('C:/LotSizing/OUTPUTS/OUTPUTSQEC.xlsx')
        if df.size == 0:
            return
    ...
    def imprimerapport(self):
        data=pd.read_excel("C:/LotSizing/OUTPUTS/OUTPUTSQEC.xlsx")
        df=pd.DataFrame(data)         
        ...
        pdf.image("C:/LotSizing/OUTPUTS/OUTPUTSQEC.png",0,30,200)
        pdf.ln(3)
        ...
        if c1>0:
             ...
             pdf.cell(-90)         
        pdf.output('C:/LotSizing/OUTPUTS/RapportQEC.pdf', 'F')
        
    def imprimegraphe(self):
        filepath2="C:/LotSizing/OUTPUTS/OUTPUTSQEC.png"
        os.startfile(filepath2,'print')                               
    def loadaGrapheQEC(self):
        file='C:/LotSizing/OUTPUTS/OUTPUTSQEC.xlsx'
        data=pd.read_excel(file)
        df=pd.DataFrame(data)   
        X=df.iloc[5,1:10]
        Y=df.iloc[6,1:10]
        ...
        plt.show()  
        plt.savefig('C:/LotSizing/OUTPUTS/OUTPUTSQEC.png');   
    ...
    def setupUi(self, QEC_Interface):
        QEC_Interface.setObjectName("QEC_Interface")
        QEC_Interface.resize(1342, 597)
        self.tableWidget = QtWidgets.QTableWidget(QEC_Interface)
        self.tableWidget.setGeometry(QtCore.QRect(0, 0, 1341, 381))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.widget = QtWidgets.QWidget(QEC_Interface)
...
"font: 75 16pt \"MS Shell Dlg 2\";")
        ...
        self.widget_2 = QtWidgets.QWidget(QEC_Interface)
...
"border-image: url(:/pic/Printer-icon.png);")
        ...
        self.retranslateUi(QEC_Interface)
        QtCore.QMetaObject.connectSlotsByName(QEC_Interface)
    ...
    def retranslateUi(self, QEC_Interface):
        _translate = QtCore.QCoreApplication.translate
        QEC_Interface.setWindowTitle(_translate("QEC_Interface", "Quantité economique_Interface"))
        self.label_8.setText(_translate("QEC_Interface", "load"))
        self.label_9.setText(_translate("QEC_Interface", "Save"))

        self.GrapheBtn.setText(_translate("QEC_Interface", "Visualiser le graphiqe"))
        self.ComparaisonGraphique.setText(_translate("QEC_Interface", "Comparer les autres graphique"))

        self.ValiderModification.setText(_translate("QEC_Interface", "Valider Les modifications"))
...
if __name__ == "__main__":
    ...
    QEC_Interface = QtWidgets.QWidget()
    ui = Ui_QEC_Interface()
    ui.setupUi(QEC_Interface)
    QEC_Interface.show()
    sys.exit(app.exec_())

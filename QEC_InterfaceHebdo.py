...
class Ui_QECHebdo(object):
    ...
    def loadaQEC(self):
      #import QEC
        ...
        df = pd.read_excel('C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSQEC.xlsx')
        if df.size == 0:
            return
    ...
    def imprimerapport(self):
        data=pd.read_excel("C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSQEC.xlsx")
        df=pd.DataFrame(data)         
        ...
        pdf.image("C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSQEC.png",0,30,200)
        pdf.ln(3)
        ...
        if c1>0:
             ...
             pdf.cell(-90)         
        pdf.output('C:/LotSizing/OUTPUTSHebdo/RapportQECHEBDO.pdf', 'F')
        

    def imprimegraphe(self):
        filepath2="C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSQEC.png"
        os.startfile(filepath2,'print')             
    def loadaGrapheQEC(self):
        file='C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSQEC.xlsx'
        data=pd.read_excel(file)
        df=pd.DataFrame(data)   
        X=df.iloc[5,1:54]
        Y=df.iloc[6,1:54]
        ...
        plt.show() 
        plt.savefig('C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSQEC.png')   
    ...
    def setupUi(self, QECHebdo):
        QECHebdo.setObjectName("QECHebdo")
        QECHebdo.resize(1342, 597)
        self.tableWidget = QtWidgets.QTableWidget(QECHebdo)
        self.tableWidget.setGeometry(QtCore.QRect(0, 0, 1341, 381))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.widget = QtWidgets.QWidget(QECHebdo)
...
"font: 75 16pt \"MS Shell Dlg 2\";")
        ...
        self.widget_2 = QtWidgets.QWidget(QECHebdo)
...
"border-image: url(:/pic/Printer-icon.png);")
        ...
        self.retranslateUi(QECHebdo)
        QtCore.QMetaObject.connectSlotsByName(QECHebdo)

    def retranslateUi(self, QECHebdo):
        _translate = QtCore.QCoreApplication.translate
        QECHebdo.setWindowTitle(_translate("QECHebdo", "QECHebdo"))
        self.label_8.setText(_translate("QECHebdo", "load"))
        self.label_9.setText(_translate("QECHebdo", "Save"))

        self.GrapheBtn.setText(_translate("QECHebdo", "Visualiser le graphiqe"))

        self.ComparaisonGraphique.setText(_translate("QECHebdo", "Comparer les autres graphique"))

        self.ValiderModification.setText(_translate("QECHebdo", "Valider Les modifications"))
import img

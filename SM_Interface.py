...
class Ui_SilverMeal_Interface(object):
    ...
    def loadaSM(self):
        ...
        df = pd.read_excel('C:/LotSizing/OUTPUTS/OUTPUTSSM.xlsx')
        if df.size == 0:
            return
    ...
    def imprimerapport(self):
        data=pd.read_excel("C:/LotSizing/OUTPUTS/OUTPUTSSM.xlsx")
        df=pd.DataFrame(data)         
        ...
        pdf.image("C:/LotSizing/OUTPUTS/OUTPUTSSM.png",0,30,200)
        pdf.ln(3)
        ...
        if c1>0:
             ...
             pdf.cell(-90)         
        pdf.output('C:/LotSizing/OUTPUTS/RapportSM.pdf', 'F')
        
    def imprimegraphe(self):
        filepath2="C:/LotSizing/OUTPUTS/OUTPUTSSM.png"
        os.startfile(filepath2,'print')       
    def loadaGrapheQEC(self):
        file='C:/LotSizing/OUTPUTS/OUTPUTSSM.xlsx'
        data=pd.read_excel(file)
        df=pd.DataFrame(data)   
        X=df.iloc[5,1:10]
        Y=df.iloc[6,1:10]
        ...
        plt.show()    
        plt.savefig('C:/LotSizing/OUTPUTS/OUTPUTSSM.png'); 
    ...
    def setupUi(self, SilverMeal_Interface):
        SilverMeal_Interface.setObjectName("SilverMeal_Interface")
        SilverMeal_Interface.resize(1342, 597)
        self.tableWidget = QtWidgets.QTableWidget(SilverMeal_Interface)
        self.tableWidget.setGeometry(QtCore.QRect(0, 0, 1341, 381))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.widget = QtWidgets.QWidget(SilverMeal_Interface)
...
"font: 75 16pt \"MS Shell Dlg 2\";")
        ...
        self.widget_2 = QtWidgets.QWidget(SilverMeal_Interface)
...
"border-image: url(:/pic/Printer-icon.png);")
        ...
        self.retranslateUi(SilverMeal_Interface)
        QtCore.QMetaObject.connectSlotsByName(SilverMeal_Interface)
        self.ValiderModification.clicked.connect(self.loadaSM)
    ...
    def retranslateUi(self, SilverMeal_Interface):
        _translate = QtCore.QCoreApplication.translate
        SilverMeal_Interface.setWindowTitle(_translate("SilverMeal_Interface", "Silver Meal_Interface"))
        self.label_8.setText(_translate("SilverMeal_Interface", "load"))
        self.label_9.setText(_translate("SilverMeal_Interface", "Save"))

        self.GrapheBtn.setText(_translate("SilverMeal_Interface", "Visualiser le graphiqe"))

        self.ComparaisonGraphique.setText(_translate("SilverMeal_Interface", "Comparer les autres graphique"))

        self.ValiderModification.setText(_translate("SilverMeal_Interface", "Valider Les modifications"))
...
if __name__ == "__main__":
    ...
    SilverMeal_Interface = QtWidgets.QWidget()
    ui = Ui_SilverMeal_Interface()
    ui.setupUi(SilverMeal_Interface)
    SilverMeal_Interface.show()
    sys.exit(app.exec_())

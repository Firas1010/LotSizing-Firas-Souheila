...
class Ui_SMAnnuel(object):
    ...
    def loadaQEC(self):
        ...
        df = pd.read_excel('C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSSM.xlsx')
        if df.size == 0:
            return
    ...
    def imprimerapport(self):
        data=pd.read_excel("C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSSM.xlsx")
        df=pd.DataFrame(data)         
        ...
        pdf.image("C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSSM.png",0,30,200)
        pdf.ln(3)
        ...
        if c1>0:
             ...
             pdf.cell(-90)         
        pdf.output('C:/LotSizing/OUTPUTSAnnuel/RapportSMAnnuelle.pdf', 'F')
        
    def imprimegraphe(self):
        filepath2="C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSSM.png"
    ...
    def loadaGrapheQEC(self):
        file='C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSSM.xlsx'
        data=pd.read_excel(file)
        df=pd.DataFrame(data)   
        X=df.iloc[5,1:14]
        Y=df.iloc[6,1:14]
        ...
        plt.show()
        plt.savefig('C:/LotSizing/OUTPUTSAnnuel/AnnuelOUTPUTSSM.png')
    ...
    def setupUi(self, SMAnnuel):
        SMAnnuel.setObjectName("SMAnnuel")
        SMAnnuel.resize(1342, 597)
        self.tableWidget = QtWidgets.QTableWidget(SMAnnuel)
        self.tableWidget.setGeometry(QtCore.QRect(0, 0, 1341, 381))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.widget = QtWidgets.QWidget(SMAnnuel)
...
"border-image: url(:/pic/Printer-icon.png);")
        ...
        self.retranslateUi(SMAnnuel)
        QtCore.QMetaObject.connectSlotsByName(SMAnnuel)
        

    def retranslateUi(self, SMAnnuel):
        _translate = QtCore.QCoreApplication.translate
        SMAnnuel.setWindowTitle(_translate("SMAnnuel", "SMAnnuel"))
        self.label_8.setText(_translate("SMAnnuel", "load"))
        self.label_9.setText(_translate("SMAnnuel", "Save"))

        self.GrapheBtn.setText(_translate("SMAnnuel", "Visualiser le graphiqe"))

        self.ComparaisonGraphique.setText(_translate("SMAnnuel", "Comparer les autres graphique"))

        self.ValiderModification.setText(_translate("SMAnnuel", "Valider Les modifications"))
import img

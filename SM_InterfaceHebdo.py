...
class Ui_SMHebdo(object):
    ...
    def loadaQEC(self):
      #import QEC
        ...
        df = pd.read_excel('C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSSM.xlsx')
        if df.size == 0:
            return
    ...
    def imprimerapport(self):
        data=pd.read_excel("C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSSM.xlsx")
        df=pd.DataFrame(data)         
        ...
        pdf.image("C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSSM.png",0,30,200)
        pdf.ln(3)
        ...
        if c1>0:
             ...
             pdf.cell(-90)         
        pdf.output('C:/LotSizing/OUTPUTSHebdo/RapportSMHBDO.pdf', 'F')

    def imprimegraphe(self):
        filepath2="C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSSM.png"
        os.startfile(filepath2,'print')                  
    def loadaGrapheQEC(self):
        file='C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSSM.xlsx'
        data=pd.read_excel(file)
        df=pd.DataFrame(data)   
        X=df.iloc[5,1:54]
        Y=df.iloc[6,1:54]
        ...
        plt.show() 
        plt.savefig('C:/LotSizing/OUTPUTSHebdo/HebdoOUTPUTSSM.png')   
    ...
    def setupUi(self, SMHebdo):
        SMHebdo.setObjectName("SMHebdo")
        SMHebdo.resize(1342, 597)
        self.tableWidget = QtWidgets.QTableWidget(SMHebdo)
        self.tableWidget.setGeometry(QtCore.QRect(0, 0, 1341, 381))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.widget = QtWidgets.QWidget(SMHebdo)
...
"font: 75 16pt \"MS Shell Dlg 2\";")
        ...
        self.widget_2 = QtWidgets.QWidget(SMHebdo)
...
"border-image: url(:/pic/Printer-icon.png);")
        ...
        self.retranslateUi(SMHebdo)
        QtCore.QMetaObject.connectSlotsByName(SMHebdo)

    def retranslateUi(self, SMHebdo):
        _translate = QtCore.QCoreApplication.translate
        SMHebdo.setWindowTitle(_translate("SMHebdo", "SMHebdo"))
        self.label_8.setText(_translate("SMHebdo", "load"))
        self.label_9.setText(_translate("SMHebdo", "Save"))

        self.GrapheBtn.setText(_translate("SMHebdo", "Visualiser le graphiqe"))

        self.ComparaisonGraphique.setText(_translate("SMHebdo", "Comparer les autres graphique"))

        self.ValiderModification.setText(_translate("SMHebdo", "Valider Les modifications"))
import img
